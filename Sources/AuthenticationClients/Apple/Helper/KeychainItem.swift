...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        if let info = Bundle.main.infoDictionary, let identifier = info["CFBundleIdentifier"] as? String{
            do {
                let storedIdentifier = try KeychainItem(service: identifier, account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        if let info = Bundle.main.infoDictionary, let identifier = info["CFBundleIdentifier"] as? String{
            do {
                try KeychainItem(service: identifier, account: "userIdentifier").deleteItem()
            } catch {
            }
        }
    }
